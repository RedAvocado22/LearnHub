...
export default function UserDetails() {
    ...
    const [user, setUser] = useState<User | Student | Teacher | null>(null);
                                    ...
                                    <form className="edit-profile m-b30">
                                        <div className="row">
                                            ...
                                            <div className="form-group col-6">
                                                ...
                                                <div>{new Date(user.joinedAt).toDateString()}</div>
                                            </div>
                                            <div className="form-group col-6">
                                                <label className="col-form-label">Account Status</label>
                                                <div className={user.active ? "text-success" : "text-danger"}>
                                            ...
                                            {user.role === UserRole.STUDENT && (
                                                <>
                                                    <div className="form-group col-6">
                                                        ...
                                                        <div>{(user as Student).studentType}</div>
                                                    </div>
                                                    <div className="form-group col-6">
                                                        <label className="col-form-label">School</label>
                                                        <div>{(user as Student).school}</div>
                                                    </div>
                                                </>
                                            )}
                                            {user.role === UserRole.TEACHER && (
                                                <>
                                                    <div className="form-group col-6">
                                                        ...
                                                        <div>{(user as Teacher).major}</div>
                                                    </div>
                                                    <div className="form-group col-6">
                                                        <label className="col-form-label">Website</label>
                                                        <div>
                                                            <a href={(user as Teacher).website} target="_blank">
                                                                {(user as Teacher).website}
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div className="form-group col-6">
                                                        <label className="col-form-label">School</label>
                                                        <div>{(user as Teacher).school}</div>
                                                    </div>
                                                    <div className="form-group col-12">
                                                        <label className="col-form-label">Biography</label>
                                                        <div>
                                                            <p>{(user as Teacher).biography}</p>
                                                        </div>
                                                    </div>
                                                </>
                                            )}

...
export default function CourseManagerDashboard() {
    ...
    const [countStudentRegister, setCountStudentRegister] = useState("");

    useEffect(() => {
        API.get(`courses/countCourseOrder`).then((resp) => {
            setCountStudentRegister(resp.data);
        });
    });

    useEffect(() => {
        API.get(`courses/coursePending`).then((resp) => {
            setCount(resp.data);
        });
    });
    return (
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
                            <div className="widget-card widget-bg2">
                                <div className="wc-item">
                                    <h4 className="wc-title">New Course Request</h4>
                                    <span className="wc-des">Customer Review</span>
                                    <span className="wc-stats counter">{count}</span>
                                    <div className="progress wc-progress">
                                        <div
                                            className="progress-bar"
                                            role="progressbar"
                        ...
                        <div className="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
                            <div className="widget-card widget-bg3">
                                <div className="wc-item">
                                    ...
                                    <span className="wc-stats counter">{countStudentRegister}</span>
                                    <div className="progress wc-progress">
                                        <div
                                            className="progress-bar"
                                            role="progressbar"
